  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Create Post to Share with Juniors or to ask doubts regarding placements from seniors or alumni. Anything related to Interview Preparation from PICT can be shared!!"
        />
        ...
        <meta
          property="og:url"
          content={`${import.meta.env.VITE_BASE_CLIENT_URL}/post`}
        />
