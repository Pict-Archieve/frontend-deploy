  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Search and filter posts about interview experience, discussion, doubts and many more about PICT"
        />
        ...
        <meta
          property="og:url"
          content={`${import.meta.env.VITE_BASE_CLIENT_URL}/posts`}
        />
